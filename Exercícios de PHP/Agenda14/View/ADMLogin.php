...
<body class="w3-light-gray">
    <form action="/Controller/Navegacao.php" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue-gray w3-margin w3-display-middle" style="width: 30%;">
    ...
    <div class="w3-row w3-section">
        <div class="">
        <button name="btnLoginADM" class="w3-button w3-block w3-margin w3-blue-gray w3-cell w3-round-large" style="width: 90%;">Entrar</button>
        </div>
    </div>
    </form>
</body>
