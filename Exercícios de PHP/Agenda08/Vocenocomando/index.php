<?php require_once ('cabecalho.php'); ?>
    <div class="w3-container w3-round-xxlarge w3-display-middle w3-card-4  w3-third ">
        ...
        <div class="w3-center">
            <br>
            <img src="img/escola.jpg" alt="escola" style="width:40%" class="w3-circle w3-margin-top">
            <br>
            <a href='https://br.freepik.com/vetores/escola'>Escola vetor criado por macrovector - br.freepik.com</a>
        </div>
        ...
        <form class="w3-container " action="loginAction.php" method="post">
            <div class="w3-section">
                ...
                <button class="w3-button w3-block w3-lime w3-section w3-padding" type="submit">Entrar</button>
            </div>
        </form>
        <br>
