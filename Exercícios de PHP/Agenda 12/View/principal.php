...
<body class="w3-light-grey">
        ...
        <div class="w3-padding-large" id="main">
            <header class="w3-container w3-padding-32 w3-center" id="home">
                <h1>
                    <img src="../Image/enlatados.jpg" alt="Logo" class="w3-image" width="50%">
                    </br>
                </h1>
        ...
        <div class="w3-padding-128 w3-content w3-text-grey" id="dPessoais">
            ...
            <form action="" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%">
                ...
                <div class="w3-row w3-section">
                    ...
                    <div class="w3-rest">
                        <input class="w3-input w3-border w3-round-large" name="txtNasc" type="date" placeholder="">
                    </div>
                </div>
        ...
        <div class="w3-padding-128 w3-content w3-text-grey" id="Ouformacoes">
            ...
            <div class="w3-row w3-section">
                ...
                <div class="w3-rest">
                    <input class="w3-input w3-border w3-round-large" name="txtCurs"type="text" placeholder="Ex.:Curso de Inglês City">
                </div>
            </div>
