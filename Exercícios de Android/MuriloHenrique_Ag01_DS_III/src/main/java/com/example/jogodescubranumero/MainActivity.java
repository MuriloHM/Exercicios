...
public class MainActivity extends AppCompatActivity {
    ...
    EditText edtValorProgOcultoProg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtValorProgOcultoProg = findViewById(R.id.edtValorOculto);
    ...
    public int gerarNumero()
    {
     ...
     public void clickBtnEnviar(View v)
     {
         ...
         if (valor == valorOculto)
         {
             ...
             edtValorProgOcultoProg.setText(""+valorOculto);
     ...
     public void clickBtnNovo(View v)
     {
         ...
         edtValorProg.setText("");
         edtValorProgOcultoProg.setText("?");
